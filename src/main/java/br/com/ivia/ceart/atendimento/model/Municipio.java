...
@Entity
@Table(name="municipio",schema="corporativo")
@JsonInclude(Include.NON_NULL)
@SequenceGenerator(name="seq_municipio",sequenceName="producao.corporativo.municipio_id_seq",allocationSize=1)
@Getter @Setter @NoArgsConstructor @ToString @EqualsAndHashCode(callSuper=false)
public class Municipio  extends BaseModel {

	private static final long serialVersionUID = -4333091873835825337L;
